...
class EvaluationReport:
    ...
    def summary(self) -> str:
        ...
        lines = [
            ...
            "║  METRIC          │ VALUE                                 ║",
            "╟" + "─" * 18 + "┼" + "─" * 39 + "╢",
            f"║  Precision@K     │ {self.retrieval.get(f'precision_at_{self.k}', '0.00'):<37.4f} ║",
            f"║  Recall@K        │ {self.retrieval.get(f'recall_at_{self.k}', '0.00'):<37.4f} ║",
            f"║  MRR             │ {self.retrieval.get('mrr', '0.00'):<37.4f} ║",
            "╟" + "─" * 18 + "┼" + "─" * 39 + "╢",
